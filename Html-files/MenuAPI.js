...
async function getMealsByCategory(category) {
    if (category.toLowerCase() === 'custom') {
        return [
            { strMeal: "Creamy Nachos", strMealThumb: "../Images/custom/creamy_nachos.jpg", idMeal: "f1" },
            { strMeal: "Satvic Frankie Rolls", strMealThumb: "../Images/custom/satvic_frankie_rolls.jpg", idMeal: "f2" },
            { strMeal: "Combo Offer 1", strMealThumb: "../Images/custom/combo_offer.jpg", idMeal: "f3" },
            { strMeal: "Garden Pizza", strMealThumb: "../Images/custom/garden_pizza.jpg", idMeal: "f4" },
            { strMeal: "Pesto Pizza", strMealThumb: "../Images/custom/pesto_pizza.jpg", idMeal: "f5" },
            { strMeal: "Combo Offer 2", strMealThumb: "../Images/custom/combo_offer1.jpg", idMeal: "f6" },
            { strMeal: "Colorful Momos", strMealThumb: "../Images/custom/colorful_momos.jpg", idMeal: "f6" },
            { strMeal: "Papdi Chaat", strMealThumb: "../Images/custom/satvic papdi chaat.jpg", idMeal: "f6" },
            { strMeal: "Saatvic Rabdi", strMealThumb: "../Images/custom/satvic rabdi.jpg", idMeal: "f6" },
            { strMeal: "Coconut Ladoo", strMealThumb: "../Images/custom/coconut ladoo.jpg", idMeal: "f6" },
            { strMeal: "Coconut Ladoo", strMealThumb: "../Images/custom/pineapple cheesecake.jpg", idMeal: "f6" },
            { strMeal: "Coconut Ladoo", strMealThumb: "../Images/custom/chocolate mousee.jpg", idMeal: "f6" },
            { strMeal: "Coconut Ladoo", strMealThumb: "../Images/custom/kesar malai kulfi.jpg", idMeal: "f6" },
            { strMeal: "Coconut Ladoo", strMealThumb: "../Images/custom/bliss balls.jpg", idMeal: "f6" },
            { strMeal: "Coconut Ladoo", strMealThumb: "../Images/custom/satvic carrot cake.jpg", idMeal: "f6" },
        ];
    }  else {
        // For other categories, continue fetching from the MealDB API
...
function renderMeals(mealData) {
    return mealData.map(
        (mealDetails) => `
        <div class="col-sm-6 col-xl-4 item" data-rating="4">
            <div class="card">
...
function filterMenu() {
    ...
    menuItems.forEach((item) => {
        ...
        // Filter by rating
        let showByRating = ratingFilter === "all" || itemRating === parseInt(ratingFilter);
